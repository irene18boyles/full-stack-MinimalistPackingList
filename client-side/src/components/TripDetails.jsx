...
const TripDetails = () => {
  ...
  useEffect(() => {
    const fetchPackingItems = async () => {
      ...
      try {
        const response = await fetch(`https://full-stack-minimalistpackinglist.onrender.com/api/items/name/${tripName}`, {
          method: "GET",
          headers: {
  ...
  const updatePackingItemsInDB = async (itemId, itemData) => {
    const token = localStorage.getItem("token");
    try {
      const response = await fetch(`https://full-stack-minimalistpackinglist.onrender.com/api/items/${itemId}`, {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  const handleRemoveItem = async (index) => {
    ...
    const token = localStorage.getItem("token");
    try {
      const response = await fetch(`https://full-stack-minimalistpackinglist.onrender.com/api/items/${itemToRemove._id}`, {
        method: "DELETE",
